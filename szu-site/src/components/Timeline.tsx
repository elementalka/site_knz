...
export default function Timeline(props: { items: { title: string; date: string; meta?: string; imageUrl?: string }[] }) {
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            {i.imageUrl ? (
              <div className="media-frame h-20 w-full shrink-0 sm:h-16 sm:w-24">
                <img src={i.imageUrl} alt={i.title} className="media-image" loading="lazy" />
              </div>
            ) : null}
